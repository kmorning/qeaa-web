...
class CorrectionsScheduleDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  ATTRIBUTE_TYPES = {
    events: Field::HasMany.with_options(class_name: "CorrectionsEvent"),
    id: Field::Number,
    name: Field::String,
  ...
  # Overwrite this method to customize how corrections schedules are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(corrections_schedule)
  #   "CorrectionsSchedule ##{corrections_schedule.id}"
  # end
end
